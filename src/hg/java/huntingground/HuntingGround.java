...
public class HuntingGround
{
    ...
    public boolean notload = false;

    public int grouplives;
    public int grouplivescurrent;

    private boolean modeDungeon;
